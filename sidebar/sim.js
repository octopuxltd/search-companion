// Standalone simulated-page renderer. Loaded inside the split-view iframes
// (and potentially elsewhere) via sim.html?kind=...&q=...&domain=...
//
// `kind` picks which mock to render:
//   google, bing, ddg, amazon, wikipedia, perplexity,
//   google-didyoumean, firefox-dnf
//
// As a real extension page (not srcdoc), this file can use regular event
// listeners for interactivity — no CSP-driven parent-side wiring needed.
...
// Full brand wordmarks/logos sourced from Wikimedia Commons. Wikipedia's
// puzzle-globe SVG is too heavy to inline, so it's rendered as a styled
// wordmark instead.
const LOGOS = {
...
// Mini circular icons used in the DNF page's engine switcher.
const MINI_ICONS = {
  ...
  bing: `<svg viewBox="0 0 678 1024" fill="none"><path fill="url(#mini-bing-a)" d="M0 778.3c14.6 123.8 223.8 143 236.8 79.9-.3-.4-.5-678.1-.5-678.1-3.6-46-26.2-72-61.6-96.5-33-22.7-74.4-50.4-96.9-66.4C14.2-28 .1 31.4 0 33.2c0 0 .3 746.4 0 745.1z"/><path fill="url(#mini-bing-b)" d="M236.8 832.8c-96.2 72.5-217 42.7-234.4-44-.8-4.2-2.4-10.4-2.4-10.4s.9 8.5 2 16.6c1.2 8.5 3.7 20.8 6.3 31.3 30 117.8 132.1 186 230.4 196.6C373.3 1034.8 497.4 931 599 855.8c6.3-6.2 15.4-16.2 18.1-20.1 66.2-95-13.6-197-72.5-193a59154 59154 0 0 0-307.7 190.1Z"/><path fill="url(#mini-bing-c)" fill-rule="evenodd" d="M312.8 381c7.4 47 34.6 108.7 59.6 172.6 20.2 41.3 62 53.4 103 65.5 42.4 12.6 65.6 21 85.6 30.9 138.5 68.7 38.5 207.7 59.6 181.4 89-110.7 79.7-325.4-90-418.1-57.6-28.7-115.4-66.6-156.5-83.6-41-17-68.7 4.3-61.3 51.3z" clip-rule="evenodd"/><defs><linearGradient id="mini-bing-a" x1="118.4" x2="118.4" y1="0" y2="884.4" gradientUnits="userSpaceOnUse"><stop stop-color="#00BBEC"/><stop offset="1" stop-color="#2756A9"/></linearGradient><radialGradient id="mini-bing-b" cx="0" cy="0" r="1" gradientTransform="matrix(526 -225.4 375.6 876.6 88.8 915.1)" gradientUnits="userSpaceOnUse"><stop stop-color="#00BBEC"/><stop offset="1" stop-color="#2756A9"/></radialGradient><radialGradient id="mini-bing-c" cx="0" cy="0" r="1" gradientTransform="matrix(-347 -399.3 287.3 -249.8 655 722)" gradientUnits="userSpaceOnUse"><stop stop-color="#00CACC"/><stop offset="1" stop-color="#048FCE"/></radialGradient></defs></svg>`,
  ddg: `<svg viewBox="0 0 32 32"><g transform="matrix(.266667 0 0 .266667 -17.954934 -5.057333)"><circle cx="127.332" cy="78.966" r="51.15" fill="#de5833"/><path fill="#fff" d="M150.47 153.477c-1.795-8.3-12.256-27.043-16.228-34.98s-7.935-19.112-6.13-26.32c.335-1.3.34-6.668 1.43-7.38 8.4-5.494 7.812-.184 11.187-2.645 1.74-1.27 3.133-2.806 3.738-4.912 2.164-7.572-3.006-20.76-8.773-26.53-1.88-1.88-4.768-3.062-8.023-3.686-1.252-1.718-3.27-3.36-6.13-4.882-5.4-2.862-12.074-4.006-18.266-2.883 1 .1 3.256 2.138 4.168 2.273-1.38.936-5.053.815-5.03 2.896 4.916-.492 10.303.285 14.834 2.297-3.602.4-6.955 1.3-9.3 2.543-6.854 3.603-8.656 10.812-6.854 20.914 1.807 10.097 9.742 46.873 12.256 59.126 2.527 12.26-5.402 20.188-10.45 22.354l5.408.36-1.8 3.973c6.484.72 13.695-1.44 13.695-1.44-1.438 3.974-11.176 5.406-11.176 5.406s4.686 1.44 12.258-1.445l12.27-4.688 3.604 9.373 6.852-6.85 2.9 7.215c-.016.007 5.388-1.797 3.58-10.088z"/><circle cx="112.81" cy="70.69" r="3.79" fill="#2d4f8e"/><circle cx="114.487" cy="69.43" r=".98" fill="#fff"/><circle cx="138.12" cy="68.445" r="3.252" fill="#2d4f8e"/><circle cx="139.563" cy="67.363" r=".838" fill="#fff"/><path fill="#fdd20a" d="M124.4 85.295c.38-2.3 6.3-6.625 10.5-6.887 4.2-.265 5.5-.205 9-1.043s12.535-3.088 15.033-4.242c2.504-1.156 13.104.572 5.63 4.738-3.232 1.8-11.943 5.13-18.172 6.987-6.22 1.86-10-1.776-12.06 1.28-1.646 2.432-.334 5.762 7.1 6.453 10.037.93 19.66-4.52 20.72-1.625s-8.625 6.508-14.525 6.623c-5.893.1-17.77-3.896-19.555-5.137s-4.165-4.13-3.67-7.148z"/><path fill="#65bc46" d="M126.426 115.292c0 4.933-.707 7.05 1.4 7.52 2.106.48 6.104 0 7.52-.938 1.4-.94.23-7.28-.236-8.466-.473-1.173-8.692-.227-8.692 1.885z"/></g></svg>`,
  amazon: `<svg viewBox="0 0 256 260"><path fill="#000" d="M150.74 108.13c0 13.14.34 24.1-6.31 35.77-5.36 9.49-13.85 15.32-23.34 15.32-12.95 0-20.5-9.87-20.5-24.43 0-28.75 25.76-33.97 50.15-33.97zm34.02 82.22c-2.23 1.99-5.46 2.13-7.97.8-11.2-9.3-13.19-13.61-19.36-22.49-18.5 18.88-31.6 24.53-55.6 24.53-28.37 0-50.48-17.5-50.48-52.57 0-27.37 14.85-46.02 35.96-55.13 18.31-8.06 43.88-9.49 63.43-11.72v-4.36c0-8.02.62-17.51-4.08-24.43-4.13-6.22-12-8.78-18.93-8.78-12.86 0-24.34 6.59-27.14 20.26-.57 3.04-2.8 6.03-5.83 6.17l-32.74-3.51c-2.75-.62-5.79-2.85-5.03-7.07C64.53 12.4 100.34.44 132.42.44c16.42 0 37.86 4.37 50.81 16.8 16.42 15.32 14.85 35.77 14.85 58.02v52.57c0 15.8 6.55 22.72 12.71 31.26 2.18 3.04 2.66 6.69-.09 8.97-6.88 5.74-19.12 16.42-25.86 22.4l-.09-.1"/><path fill="#f90" d="M221.5 210.32c-105.23 50.08-170.54 8.18-212.35-17.27-2.59-1.6-6.98.38-3.17 4.76 13.93 16.89 59.57 57.59 119.15 57.59 59.62 0 95.09-32.53 99.53-38.21 4.41-5.63 1.29-8.73-3.16-6.87z"/></svg>`,
  wikipedia: `<svg viewBox="0 0 24 24"><path fill="#202122" d="M12.09 13.119c-.936 1.932-2.217 4.548-2.853 5.728-.616 1.074-1.127.931-1.532.029-1.406-3.321-4.293-9.144-5.651-12.409-.251-.601-.441-.987-.619-1.139-.181-.15-.554-.24-1.122-.271C.103 5.033 0 4.982 0 4.898v-.455l.052-.045c.924-.005 5.401 0 5.401 0l.051.045v.434c0 .119-.075.176-.225.176l-.564.031c-.485.029-.727.164-.727.436 0 .135.053.33.166.601 1.082 2.646 4.818 10.521 4.818 10.521l.136.046 2.411-4.81-.482-1.067-1.658-3.264s-.318-.654-.428-.872c-.728-1.443-.712-1.518-1.447-1.617-.207-.023-.313-.05-.313-.149v-.468l.06-.045h4.292l.113.037v.451c0 .105-.076.15-.227.15l-.308.047c-.792.061-.661.381-.136 1.422l1.582 3.252 1.758-3.504c.293-.64.233-.801.111-.947-.07-.084-.305-.22-.812-.24l-.201-.021c-.052 0-.098-.015-.145-.051-.045-.031-.067-.076-.067-.119v-.436l.059-.045c1.247-.008 4.043 0 4.043 0l.059.045v.437c0 .119-.074.18-.209.18-.648.03-1.127.18-1.443.421-.314.255-.557.616-.736 1.067 0 0-4.043 9.258-5.426 12.339-.525 1.007-1.053.917-1.503-.031-.571-1.171-1.773-3.786-2.646-5.71l.053-.036z"/></svg>`,
  perplexity: `<svg viewBox="0 0 24 24"><path fill="#1FB8CD" d="M22.398 7.09h-2.31V.067l-7.51 6.355V.158h-1.155v6.196L4.49 0v7.09H1.602v10.397h2.888V24l6.932-6.359v6.2h1.156v-6.046l6.932 6.18v-6.488h2.888V7.09zm-3.466-4.531v4.531h-5.355l5.355-4.531zM5.646 2.626l4.87 4.464H5.646V2.626zM2.758 16.332V8.245h7.847l-6.114 6.115v1.972H2.758zm2.888 5.04v-3.885h.001v-2.649l5.776-5.776v7.011L5.646 21.37zm12.708.025-5.777-5.151V9.062l5.777 5.776v6.559zm2.888-5.065h-1.733v-1.972L13.395 8.245h7.847v8.087z"/></svg>`,
};

// Real search URLs per engine — used by the DNF page's switcher.
const ENGINE_URL = {
  google: (q) => "https://www.google.com/search?client=firefox-b-d&q=" + encodeURIComponent(q),
...
const ENGINE_NAMES = {
  ...
  amazon: "Amazon", wikipedia: "Wikipedia", perplexity: "Perplexity",
};

// Pool of mock results. Some include `subPages` (rendered as sitelinks).
const POOL = [
...
function pick(n) { return shuffle(POOL).slice(0, n); }
...
const baseStyles = `
  ...
  /* Header fades in first, body shortly after, AI overview (Google only) a
     touch later. Per-pane delays are inlined as a style attribute so each
     iframe stays slightly out of sync. */
...
// Each builder returns { styles, body }. Renderer injects them into the doc.

function googleBuilder(q) {
  ...
  return {
    ...
    body: `
      ...
      <div class="fade-body" style="animation-delay:${d.body}ms">
        ...
        ${commonResultsHtml(pick(8), "#006621", "#1a0dab")}
      </div>
    `,
  };
}

function bingBuilder(q) {
  const d = revealDelays();
  return {
    styles: `
    ...
    body: `
      ...
      <div class="fade-body" style="animation-delay:${d.body}ms">
        ...
        ${commonResultsHtml(pick(9), "#008272", "#2330a8")}
      </div>
    `,
  };
}

function genericBuilder(engineId, q) {
  const d = revealDelays();
  return {
    styles: `
...
function googleDidYouMeanBuilder(q) {
  const d = revealDelays();
  return {
    styles: `
      body { font: 14px/1.5 Arial,"Helvetica Neue",sans-serif; color: #202124; }
    ...
    body: `
      ...
      <div class="fade-body" style="animation-delay:${d.body}ms">
        ...
        ${commonResultsHtml(targetResults(), "#006621", "#1a0dab")}
      </div>
    `,
  };
}
...
function dnfBuilder() {
  return {
    styles: `
      ...
      .engine-panel { position: absolute; top: calc(100% + 8px); left: 0; z-index: 20; min-width: 180px; padding: 4px; background: #fff; border: 1px solid #ccc; border-radius: 10px; box-shadow: 0 8px 24px rgba(0,0,0,0.12); }
      .engine-item { display: flex; align-items: center; gap: 10px; width: 100%; padding: 6px 10px; font: inherit; font-size: 13px; color: #15141a; background: transparent; border: none; border-radius: 6px; text-align: left; cursor: pointer; }
      .engine-item:hover, .engine-item:focus { background: #f6f7f8; outline: none; }
...
const BUILDERS = {
  google: () => googleBuilder(query),
  bing: () => bingBuilder(query),
  ddg: () => genericBuilder("ddg", query),
  amazon: () => genericBuilder("amazon", query),
  wikipedia: () => genericBuilder("wikipedia", query),
  perplexity: () => genericBuilder("perplexity", query),
  "google-didyoumean": () => googleDidYouMeanBuilder(query),
  "firefox-dnf": () => dnfBuilder(),
};
...
if (kind === "firefox-dnf" && document.getElementById("dnfForm")) {
  ...
  form.addEventListener("submit", (e) => {
    ...
    if (!q) return;
    window.top.location.href = ENGINE_URL[currentId](q);
  });
